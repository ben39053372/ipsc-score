...
export default function LeaderboardScreen() {
    ...
    const params = useLocalSearchParams<{ matchId?: string; baseUrl?: string; matchName?: string }>();
    ...
    useEffect(() => {
        ...
        const stillExists = selectedGroupName !== null && scoreGroups.some((group) => group.groupName === selectedGroupName);
        if (!stillExists) {
    ...
    const scoreSections = useMemo(
        () => {
            ...
            const group = scoreGroups.find((item) => item.groupName === selectedGroupName);
            if (!group) {
                return [];
            }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerCard}>
                ...
                <Pressable onPress={() => void loadScore()} style={styles.secondaryButton}>
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                            ...
                            <View style={styles.scoreValues}>
                                <Text style={styles.scoreValue}>{formatScore(item.totalStagePoint)}</Text>
